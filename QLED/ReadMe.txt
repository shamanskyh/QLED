QLED allows QLab to control LED Tape.
...
Technical Notes:
- A two-byte array is written to the Aruino, with the first value representing
  the color to change, and the second representing the intensity of the color.
